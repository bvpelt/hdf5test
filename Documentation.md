...
Makes VS Code use your .venv automatically

Enables pytest on the tests/ folder

Keeps your workspace clean from compiled Python files

Enables import auto-organizing

## (Optional) Add Python debug configuration
    ...
    "configurations": [
        {
            ...
            "type": "python",
            "request": "launch",
            "program": "${workspaceFolder}/hdf5test/example.py",
